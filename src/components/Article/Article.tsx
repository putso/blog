      ...
      <header>
        <div className={style.header}>
          <div className={style.article__info}>
            <h1 className={style.article__name}>Some article title</h1>
            <div className={style.like}>
              <Like value={false}></Like>{" "}
              <span className={style.count}>123</span>
            </div>

            <Tag className={style.tag}>Tag 1</Tag>
          </div>
          <div className={style.user}>
            <div>
              <h2 className={style.name}>John Doe</h2>
              <span className={style.date}>March 5, 2020 </span>
            </div>
            <Avatar size={46} icon={<DefaultAvatar />} />
          </div>
        </div>
...
function DefaultAvatar() {
  return (
    ...
    >
      <rect y="3.05176e-05" width="46" height="46" fill="url(#pattern0)" />
      <defs>
        <pattern
          id="pattern0"
          ...
          height="1"
        >
          <use xlinkHref="#image0_9608_93" transform="scale(0.00666667)" />
        </pattern>
        <image
          id="image0_9608_93"
          width="150"
